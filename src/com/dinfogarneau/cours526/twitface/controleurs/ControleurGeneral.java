	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (this.uri.equals("/connexion")) {
			...
			if (connexion.getMessageErreur() == null) {
				request.getSession().setAttribute("modeConn", connexion.getConnexionBean().getModeConn());
				request.getSession().setAttribute("nom", connexion.getConnexionBean().getNom());
				request.getSession().setAttribute("nomUtil", connexion.getConnexionBean().getNomUtil());
				...
				//request.getSession().setAttribute("msg-erreur", connexion.getMessageErreur());
				request.setAttribute("msg-erreur", connexion.getMessageErreur());
				String source = request.getParameter("source");
				if (source == null) source = this.getServletContext().getContextPath();
